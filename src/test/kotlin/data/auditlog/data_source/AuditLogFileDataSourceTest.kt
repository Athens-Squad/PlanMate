...
class AuditLogFileDataSourceTest {
    ...
    private lateinit var fileHandler: CsvFileHandler
    private lateinit var parser: CsvFileParser<AuditLogCsvDto>

    @BeforeEach
    fun setUp() {
        fileHandler = mockk<CsvFileHandler>()
        parser = mockk<CsvFileParser<AuditLogCsvDto>>()
